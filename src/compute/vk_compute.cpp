...
void ComputeManager::clearImage(VkCommandBuffer cmd, VkImageView imageView, const glm::vec4 &clearColor)
{
    if (!hasPipeline("clear_image"))
    {
        ...
        createInfo.shaderPath = context->getAssets()->shaderPath("compute/clear_image.comp.spv");
                                ...
                                VkDeviceSize srcOffset, VkDeviceSize dstOffset)
{
    ...
    {
        ComputePipelineCreateInfo createInfo;
        createInfo.shaderPath = context->getAssets()->shaderPath("compute/copy_buffer.comp.spv");
