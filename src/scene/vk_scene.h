...
public:
    ...
    bool setDynamicInstanceVisualTransform(const std::string &name, const glm::mat4 &transform);
    bool setDynamicInstanceVisualTRSWorld(const std::string &name,
                                          const WorldVec3 &translationWorld,
                                          const glm::quat &rotation,
                                          const glm::vec3 &scale);
    ...
    struct GLTFInstance
    {
        ...
        WorldVec3 translation_world{0.0, 0.0, 0.0};
        glm::quat rotation{1.0f, 0.0f, 0.0f, 0.0f};
        glm::quat visual_rotation{1.0f, 0.0f, 0.0f, 0.0f};
        glm::vec3 scale{1.0f, 1.0f, 1.0f};
    ...
    bool setGLTFInstanceVisible(const std::string &name, bool visible);
    ...
    bool setGLTFInstanceTRSWorld(const std::string &name, const WorldVec3 &translationWorld, const glm::quat &rotation, const glm::vec3 &scale, bool syncPhysicsBody = true);
    bool setGLTFInstanceVisualRotation(const std::string &name, const glm::quat &rotation);
