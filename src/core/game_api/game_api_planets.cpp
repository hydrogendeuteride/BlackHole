...
bool Engine::add_planet_terrain(const PlanetTerrain &planet)
{
    ...
    info.height_offset_m = planet.height_offset_m;
...
void Engine::set_planet_clouds_settings(const PlanetCloudSettings &settings)
{
    ...
    dst.typeBias = std::clamp(settings.typeBias, 0.0f, 1.0f);
    ...
    dst.noiseBlend = settings.noiseBlend;
    dst.detailErode = settings.detailErode;
    dst.weatherEvolutionPeriodS = settings.weatherEvolutionPeriodS;
    dst.detailEvolutionPeriodS = settings.detailEvolutionPeriodS;
    dst.windSpeed = settings.windSpeed;
    dst.windAngleRad = settings.windAngleRad;
    dst.cloudSteps = settings.cloudSteps;
    dst.resolutionDiv = settings.resolutionDiv;
    dst.shadowsEnabled = settings.shadowsEnabled;
    dst.shadowStrength = settings.shadowStrength;
    dst.shadowExtentM = settings.shadowExtentM;
    dst.shadowSteps = settings.shadowSteps;
}
...
PlanetCloudSettings Engine::get_planet_clouds_settings() const
{
    ...
    out.noiseBlend = src.noiseBlend;
    out.detailErode = src.detailErode;
    out.weatherEvolutionPeriodS = src.weatherEvolutionPeriodS;
    out.detailEvolutionPeriodS = src.detailEvolutionPeriodS;
    out.windSpeed = src.windSpeed;
    out.windAngleRad = src.windAngleRad;
    out.cloudSteps = src.cloudSteps;
    out.resolutionDiv = src.resolutionDiv;
    out.shadowsEnabled = src.shadowsEnabled;
    out.shadowStrength = src.shadowStrength;
    out.shadowExtentM = src.shadowExtentM;
    out.shadowSteps = src.shadowSteps;
    return out;
}
