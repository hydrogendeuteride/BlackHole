...
info.vertexShaderPath   = context->getAssets()->shaderPath("lighting/deferred.vert.spv");
info.fragmentShaderPath = context->getAssets()->shaderPath("lighting/deferred.frag.spv");
