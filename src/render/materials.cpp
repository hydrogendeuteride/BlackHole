...
void GLTFMetallic_Roughness::build_pipelines(VulkanEngine *engine)
{
    ...
    opaqueInfo.vertexShaderPath = engine->_context->getAssets()->shaderPath("materials/mesh.vert.spv");
    opaqueInfo.fragmentShaderPath = engine->_context->getAssets()->shaderPath("materials/mesh.frag.spv");
    ...
    meshVfxInfo.fragmentShaderPath = engine->_context->getAssets()->shaderPath("materials/mesh_vfx.frag.spv");
    ...
    gbufferInfo.vertexShaderPath = engine->_context->getAssets()->shaderPath("materials/mesh.vert.spv");
    gbufferInfo.fragmentShaderPath = engine->_context->getAssets()->shaderPath("materials/gbuffer.frag.spv");
                                                        ...
                                                        DescriptorAllocatorGrowable &descriptorAllocator)
{
    ...
    writer.write_image(5, resources.emissiveImage.imageView, resources.emissiveSampler,
                       VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
    writer.write_image(6, resources.planetSpecularImage.imageView, resources.planetSpecularSampler,
                       VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER);
