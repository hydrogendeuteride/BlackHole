...
private:
    ...
    struct FrameCache
    {
        std::unordered_map<std::string, std::vector<CachedImage>> images;
        std::unordered_map<std::string, std::vector<CachedBuffer>> buffers;
    };
    ...
    std::unordered_map<FrameResources*, FrameCache> _frameCaches;
    std::unordered_map<std::string, size_t> _imageUseCounts;
    std::unordered_map<std::string, size_t> _bufferUseCounts;
};
