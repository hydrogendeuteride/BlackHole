...
namespace
{
    ...
    constexpr const char *k_orbit_vert = "debug/debug_lines.vert.spv";
    constexpr const char *k_orbit_frag = "debug/debug_lines.frag.spv";
                                    ...
                                    bool is_ldr_target)
{
    ...
    const glm::mat4 viewproj = ctx_local->getSceneData().viewproj;
