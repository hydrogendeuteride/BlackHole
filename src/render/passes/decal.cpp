...
void DecalPass::init(EngineContext *context)
{
    ...
    info.vertexShaderPath = _context->getAssets()->shaderPath("effects/decal.vert.spv");
    info.fragmentShaderPath = _context->getAssets()->shaderPath("effects/decal.frag.spv");
