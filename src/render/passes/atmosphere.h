...
public:
    ...
    CloudShadowMap register_cloud_shadow(RenderGraph *graph);
...
private:
    ...
    struct HistorySnapshot
    {
        ...
        float cloudExtinction = 0.0f;
        glm::vec3 cloudTint{1.0f};
        ...
        float cloudWeatherEvolutionPeriodS = 0.0f;
        float cloudDetailEvolutionPeriodS = 0.0f;
    ...
    void release_history_images(bool deferred = false);
    void ensure_history_images(VkExtent2D extent);

    EngineContext *_context = nullptr;
    VkDescriptorSetLayout _cloudShadowSetLayout = VK_NULL_HANDLE;
    ...
    AllocatedImage _blackFallback3D{};
