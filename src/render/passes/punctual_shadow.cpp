...
void PunctualShadowPass::init(EngineContext *context)
{
    ...
    info.vertexShaderPath = _context->getAssets()->shaderPath("lighting/punctual_shadow.vert.spv");
    info.fragmentShaderPath = _context->getAssets()->shaderPath("lighting/punctual_shadow.frag.spv");
