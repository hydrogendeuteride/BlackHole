...
namespace Physics
{
    ...
    public:
        ...
        glm::vec3 get_unit_inertia(BodyId id) const override;
        bool get_mass_properties(BodyId id,
                                 MassProperties &out) const override;
        ...
        bool set_mass(BodyId id, float mass) override;
        bool set_mass_properties(BodyId id,
