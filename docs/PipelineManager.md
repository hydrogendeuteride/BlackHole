...
info.vertexShaderPath = context->getAssets()->shaderPath("materials/mesh.vert.spv");
info.fragmentShaderPath = context->getAssets()->shaderPath("materials/mesh.frag.spv");
...
c.shaderPath = context->getAssets()->shaderPath("compute/blur.comp.spv");
c.descriptorTypes = {
...
ComputePipelineCreateInfo c{};
c.shaderPath = context->getAssets()->shaderPath("compute/work.comp.spv");
c.descriptorTypes = { VK_DESCRIPTOR_TYPE_STORAGE_IMAGE };
