...
- **MassProperties**: Full mass, local center of mass, and symmetric local inertia tensor shared by gameplay and Jolt.
...
| `bool get_mass_properties(BodyId, MassProperties&) const` | Get mass, local center of mass, and full inertia tensor |
...
| `bool set_mass_properties(BodyId, const MassProperties&)` | Replace dynamic mass, center of mass, and full inertia tensor |
